...
export const getFlipkartLightTheme = ({ ThemeCore }: { ThemeCore: IThemeCore }): IThemeSystem => ({
  color: {
    surface: {
      neutral: {
        default: ThemeCore.color.grey[0],
        hover: ThemeCore.color.grey[50],
        pressed: ThemeCore.color.grey[100],
      },
      brand: {
        default: ThemeCore.color.blue[500],
        hover: ThemeCore.color.blue[600],
        pressed: ThemeCore.color.blue[700],
      },
      accent: {
        default: ThemeCore.color.yellow[700],
        hover: ThemeCore.color.yellow[800],
        pressed: ThemeCore.color.yellow[900],
      },
      information: {
        default: ThemeCore.color.grey[50],
        hover: ThemeCore.color.grey[100],
        pressed: ThemeCore.color.grey[200],
      },
      inverse: {
      ...
      success: {
        default: ThemeCore.color.green[50],
        hover: ThemeCore.color.green[100],
        pressed: ThemeCore.color.green[200],
      },
      warning: {
      ...
      danger: {
        default: ThemeCore.color.red[50],
        hover: ThemeCore.color.red[100],
        pressed: ThemeCore.color.red[200],
      },
      selected: {
        default: ThemeCore.color.blue[50],
        hover: ThemeCore.color.blue[100],
        pressed: ThemeCore.color.blue[200],
      },
      disabled: {
        default: ThemeCore.color.grey[50],
        hover: ThemeCore.color.grey[50],
        pressed: ThemeCore.color.grey[50],
      },
      input: {
        default: ThemeCore.color.grey[0],
        hover: ThemeCore.color.grey[50],
    ...
    tag: {
      promotion: ThemeCore.color.magenta[500],
      saving: ThemeCore.color.yellow[500],
      combo: ThemeCore.color.teal[500],
      category: ThemeCore.color.grey[200],
      recommended: ThemeCore.color.grey[900],
    },
    text: {
      primary: ThemeCore.color.grey[900],
      secondary: ThemeCore.color.grey[700],
      brand: ThemeCore.color.blue[500],
      information: ThemeCore.color.blue[500],
      inverse: ThemeCore.color.grey[0],
      success: ThemeCore.color.green[500],
      warning: ThemeCore.color.mustard[500],
      danger: ThemeCore.color.red[500],
      selected: ThemeCore.color.blue[500],
      disabled: ThemeCore.color.grey[500], // Differs from new theme
    },
    skeleton: {
      neutral: ThemeCore.color.grey[100],
      subtle: ThemeCore.color.grey[50],
    },
    icon: {
      primary: ThemeCore.color.grey[900],
      secondary: ThemeCore.color.grey[700],
      ...
      danger: ThemeCore.color.red[500],
      selected: ThemeCore.color.blue[500],
      disabled: ThemeCore.color.grey[300], // Differs from new theme
    },
    stroke: {
      primary: ThemeCore.color.grey[200],
      secondary: ThemeCore.color.grey[100],
      brand: ThemeCore.color.blue[500],
      brandlight: ThemeCore.color.blue[300],
      accent: ThemeCore.color.yellow[700],
      information: ThemeCore.color.blue[300],
      inverse: ThemeCore.color.grey[0],
      success: ThemeCore.color.green[200],
      warning: ThemeCore.color.mustard[200],
      danger: ThemeCore.color.red[500],
      dangerlight: ThemeCore.color.red[200],
      selected: ThemeCore.color.blue[500], // Differs from new theme
      disabled: ThemeCore.color.grey[300],
    },
  },
  spacing: {
